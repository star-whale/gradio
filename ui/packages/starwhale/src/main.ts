// import Blocks from "../../app/src/Blocks.sveltemport Login from "../a../../app/src/Login.sveltet { Component as Loader } from "../src/components/StatusTrackeracker";
// import { fn } from "../src/apic/api";
// import config from "./config../config.jsonrt type { ComponentMeta, Dependency, LayoutNode } from "../src/components/typestypes";

import Blocks from "@gradio/app/Blocks.svelte";
...
import type {
	...
	Dependency,
	LayoutNode
} from "@gradio/app/components/types";
...
async function unscoped_mount() {
	const target = document.querySelector("#online-eval")! as HTMLDivElement;
